---
title:  Expansión de la CASEN sobre el CENSO (Región 16)
author:
- name: VE-CC-AJ
  affiliation: DataIntelligence
subtitle: | 
  ESCOLARIDAD : Correlación: 0.8717
...
##  Modelo cuadrático (**cuadrático**)

Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.7354).


###  Diagrama de dispersión sobre **cuadrático**
...
```{r}
saveRDS(h_y_m_comuna_corr, "Rural/region_16_ESCOLARIDAD_r.rds")
```
