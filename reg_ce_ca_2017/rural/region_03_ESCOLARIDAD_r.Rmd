---
title:  Expansión de la CASEN sobre el CENSO (Región 03)
author:
- name: VE-CC-AJ
...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.5608 ).
...
```{r}
saveRDS(h_y_m_comuna_corr, "Rural/region_03_ESCOLARIDAD_r.rds")
```
