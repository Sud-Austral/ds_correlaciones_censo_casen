...
subtitle: | 
  ESCOLARIDAD: Correlación: 0.7352
...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.7352).
...
```{r}
saveRDS(h_y_m_comuna_corr, "Rural/region_08_ESCOLARIDAD_r.rds")
```
