...
subtitle: | 
  ESCOLARIDAD  : Correlación: 0.49237
...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.7229 ).
...
```{r}
saveRDS(h_y_m_comuna_corr, "Rural/region_01_ESCOLARIDAD_r.rds")
```
