---
title:  Expansión de la CASEN sobre el CENSO (Región 04)
author:
- name: VE-CC-AJ
  affiliation: DataIntelligence
subtitle: | 
  ESCOLARIDAD ESCOLARIDAD: Correlación: 0.49237




abstract: |
 Expandiremos los ingresos promedios comunales obtenidos de la CASEN sobre la categoría de respuesta: "ESCOLARIDAD" del campo ESCOLARIDAD del CENSO de viviendas -ambos del 2017-, que fue la categoría de respuesta que más alto correlacionó con los ingresos expandidos (obtenidos de la multiplicación del ingreso promedio y los habitantes), ambos a nivel comunal.
...
##  Modelo raíz-raíz (**raíz-raíz**)

Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.6716 ).


###  Diagrama de dispersión sobre **raíz-raíz**
...
```{r}
saveRDS(h_y_m_comuna_corr, "Rural/region_04_ESCOLARIDAD_r.rds")
```
