---
title:  Expansión de la CASEN sobre el CENSO (Región 06)
author:
- name: VE-CC-AJ
...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.7519 ).
...
```{r}
saveRDS(h_y_m_comuna_corr, "Rural/region_06_ESCOLARIDAD_r.rds")
```
