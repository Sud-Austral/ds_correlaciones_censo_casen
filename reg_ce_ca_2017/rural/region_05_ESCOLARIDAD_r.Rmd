---
title:  Expansión de la CASEN sobre el CENSO (Región 05)
author:
- name: VE-CC-AJ
...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.7669 ).
...
```{r}
saveRDS(h_y_m_comuna_corr, "Rural/region_05_ESCOLARIDAD_r.rds")
```
