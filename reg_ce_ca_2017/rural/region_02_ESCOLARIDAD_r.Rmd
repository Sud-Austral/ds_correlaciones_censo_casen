...
##  Modelo raíz cuadrada (**raíz cuadrada**)

Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.6452).


###  Diagrama de dispersión sobre **raíz cuadrada**
...
```{r}
saveRDS(h_y_m_comuna_corr, "Rural/region_02_ESCOLARIDAD_r.rds")
```
