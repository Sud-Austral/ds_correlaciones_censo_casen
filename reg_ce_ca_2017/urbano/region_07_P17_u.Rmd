---
title:  Expansión de la CASEN sobre el CENSO (Región 07)
author:
- name: VE-CC-AJ
...
# Resumen 
  ...
  Haremos el análisis sobre la región 07.
...
Si bien obtenemos nuestro modelo lineal da cuenta del 0.9653 de la variabilidad de los datos de respuesta en torno a su media, modelos alternativos pueden ofrecernos una explicación de la variable dependiente aún mayor.
...
$$  \hat Y = e^{13.13441+1.033460 \cdot ln{X}}  $$
...
```{r}
saveRDS(h_y_m_comuna_corr, "URBANO/region_07_P17_u.rds")
```
