...
Hagamos un subset con la region = 15, y área URBANA = 1.
...
Si bien obtenemos nuestro modelo lineal da cuenta del 0.934 de la variabilidad de los datos de respuesta en torno a su media, el intercepto no es estadísticamente significativo. Modelos alternativos pueden ofrecernos una explicación de la variable dependiente aún mayor.
...
Elegimos el modelo **raíz-raíz** (5) pues tiene el más alto $R^2 (0.946)$
...
<span style="color:red">Error: el intercepto no resulta estadísticamente significante, busquemos el tercero.</span>
...
```{r}
saveRDS(h_y_m_comuna_corr, "URBANO/region_14_P17_u.rds")
```
