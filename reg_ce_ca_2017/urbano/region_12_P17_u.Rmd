---
title:  Expansión de la CASEN sobre el CENSO (Región 12)
author:
- name: VE-CC-AJ
...
Si bien obtenemos nuestro modelo lineal da cuenta del 0.9777 de la variabilidad de los datos de respuesta en torno a su media, el intercepto no es estadísticamente significativo. Modelos alternativos pueden ofrecernos una explicación de la variable dependiente aún mayor.
...
Elegimos el modelo log-log (8) pues tiene el más alto $R^2 (0.9885)$
...
```{r}
saveRDS(h_y_m_comuna_corr, "URBANO/region_12_P17_u.rds")
```
