...
```{r}
tabla_con_clave <- readRDS("../../../ds_correlaciones_censo_casen/corre_ing_exp-censo_casen/censos/censo_viviendas_con_clave_17.rds")
...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.892).
...
```{r}
saveRDS(h_y_m_comuna_corr, "P03C/region_01_P03C_u.rds")
```
