...
```{r}
comunas_censo_casen$multipob <- comunas_censo_casen$Ingresos_expandidos*comunas_censo_casen$p.x
```
```{r}
head(comunas_censo_casen,5)
```
...
```{r}
comunas_censo_casen$ing_medio_zona <- comunas_censo_casen$est_ing /(comunas_censo_casen$personas  * comunas_censo_casen$p.x)
