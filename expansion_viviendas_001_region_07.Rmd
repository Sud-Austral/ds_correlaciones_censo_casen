...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.7743).
...
```{r}
h_y_m_comuna_corr_01$est_ing <- exp(15.49891 +0.95618  * log(h_y_m_comuna_corr_01$Freq.x))
...
```{r}
saveRDS(h_y_m_comuna_corr_01, "casen_censo_region_07.rds")
```
