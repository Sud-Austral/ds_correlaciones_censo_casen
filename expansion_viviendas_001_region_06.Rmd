...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.8032).
...
```{r}
h_y_m_comuna_corr_01$est_ing <- exp(15.76975+0.89426 * log(h_y_m_comuna_corr_01$Freq.x))
...
```{r}
saveRDS(h_y_m_comuna_corr_01, "casen_censo_region_06.rds")
```
