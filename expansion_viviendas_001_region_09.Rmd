---
title: Expansión de la CASEN sobre el CENSO (Región 09)
author:
- name: VE-CC-AJ
...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.697).
...
```{r}
h_y_m_comuna_corr_01$est_ing <- 2072.04^2 + 2 * 2072.04 * 4867.31 *log(h_y_m_comuna_corr_01$Freq.x)+  4867.31^2 * (log(h_y_m_comuna_corr_01$Freq.x))^2
...
```{r}
saveRDS(h_y_m_comuna_corr_01, "casen_censo_region_09.rds")
```
