...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.5112). 
...
-7978472  + 16016176 * sqrt (h_y_m_comuna_corr_01$Freq.x)
...
```{r}
saveRDS(h_y_m_comuna_corr_01, "P15/region_09_P15_r.rds")
```
