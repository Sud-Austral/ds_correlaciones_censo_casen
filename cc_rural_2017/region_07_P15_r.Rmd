...
Hagamos un subset con la region 07 y con la zona = 2:
...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.7154). 
...
(1740.6)^2 + 2 * 1740.6 * 1554.5 * sqrt(h_y_m_comuna_corr_01$Freq.x)+  1554.5^2 * (h_y_m_comuna_corr_01$Freq.x) 
...
```{r}
saveRDS(h_y_m_comuna_corr_01, "P15/region_07_P15_r.rds")
```
