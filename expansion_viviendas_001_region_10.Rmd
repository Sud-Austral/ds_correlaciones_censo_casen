...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.6989).
...
```{r}
h_y_m_comuna_corr_01$est_ing <- exp(16.27921+0.83440 * log(h_y_m_comuna_corr_01$Freq.x)) 
...
```{r}
saveRDS(h_y_m_comuna_corr_01, "casen_censo_region_10.rds")
```
