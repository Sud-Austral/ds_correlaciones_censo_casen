...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.9042).
...
```{r}
h_y_m_comuna_corr_01$est_ing <- exp(15.3235+0.9461 * log(h_y_m_comuna_corr_01$Freq.x))
...
```{r}
saveRDS(h_y_m_comuna_corr_01, "casen_censo_region_15.rds")
```
