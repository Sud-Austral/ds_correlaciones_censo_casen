...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.8819).
...
```{r}
h_y_m_comuna_corr_01$est_ing <- exp(15.42700 + 0.96940 * log( h_y_m_comuna_corr_01$Freq.x))
...
```{r}
saveRDS(h_y_m_comuna_corr_01, "casen_censo_region_02.rds")
```
