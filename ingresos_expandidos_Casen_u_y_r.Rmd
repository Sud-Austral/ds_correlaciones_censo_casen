...
casen_2017 <- readRDS(file = "../../archivos_grandes/Casen en Pandemia 2020 SPSS.sav")
```


### 1.1.2 Eliminamos del dataframe los registros que no posean valores en la columna del ingreso total:

lo anterior es un error porque subestimamos la pobreza.

```{r}
casen_2017 <- casen_2017[c(1:1000),]
```
