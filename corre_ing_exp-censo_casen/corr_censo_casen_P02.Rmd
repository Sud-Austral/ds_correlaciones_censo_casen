...
df_2017_2 <- df_2017_2[,-c(2,4,6,8,10,11,12,13,14)]
...
chart.Correlation(df_2017_2, histogram=TRUE, method = c( "kendall"), pch=20)
```
...
chart.Correlation(df_2017_2, histogram=TRUE, method = c( "pearson"), pch=20)
```
...
chart.Correlation(df_2017_2, histogram=TRUE, method = c( "spearman"), pch=20)
```
...
df_2017_2 <- df_2017_2[,-c(1)]
df_2017_2 <- filter(df_2017_2, df_2017_2$Ingresos_expandidos != 'is.na')
write_xlsx(df_2017_2,"P02_rural.xlsx")
