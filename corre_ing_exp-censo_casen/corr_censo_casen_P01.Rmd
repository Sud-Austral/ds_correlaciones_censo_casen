...
abstract: |
  Calculamos correlaciones entre el ingreso promedio comunal **multiplicado por la población comunal** que llamaremos **ingresos expandidos** extraído de la Casen 2017 y las frecuencias de categorías de respuesta para todas la variable cantidad de personas del Censo de viviendas, hogares y personas al 2017, también extraídas a nivel comunal.
