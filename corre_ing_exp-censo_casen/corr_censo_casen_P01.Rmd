...
### 1.1.4 Ingresos promedio por comuna a nivel urbano
...
### 1.1.5 Ingresos promedio por comuna a nivel rural
...
<span style="color:red">¿Con éstas correlaciones tan bajas, utilizamos también la información a nivel rural?, se propone que si, pues aún falta la aplicación de los diferentes modelos en el momento de la regresión lineal.</span>
