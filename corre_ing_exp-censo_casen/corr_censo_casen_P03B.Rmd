...
abstract: |
  Calculamos correlaciones entre el ingreso promedio comunal **multiplicado por la población comunal** que llamaremos **ipcmp** extraído de la Casen 2017 y las frecuencias de categorías de respuesta para P03B del Censo de viviendas, hogares y personas al 2017, también extraídas a nivel comunal.
...
## 1 Pregunta **P03B**: Material en la cubierta del techo 
...
```{r, warning = FALSE}
my_data <- df_2017_2[, c(3,6,9,12,15,18,21,27)]
...
## 2 Pregunta **P03B**: Material en la cubierta del techo 
