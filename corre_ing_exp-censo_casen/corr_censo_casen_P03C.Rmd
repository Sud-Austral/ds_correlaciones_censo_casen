...
## Pregunta **P03C**: Ocupación de la vivienda
...
df_2017_2 <- df_2017_2[,-c(2,4,6,8,10,12,13,14,15,16)]
```
...
df_2017_2_s <- df_2017_2[,-c(1),drop=FALSE] 
...
```{r, warning = FALSE}
chart.Correlation(df_2017_2_s, histogram=TRUE, method = c( "kendall"), pch=20)
```

### Pearson
 
```{r, warning = FALSE}
chart.Correlation(df_2017_2_s, histogram=TRUE, method = c( "pearson"), pch=20)
```

### Spearman

```{r, warning = FALSE}
chart.Correlation(df_2017_2_s, histogram=TRUE, method = c( "spearman"), pch=20)
```
