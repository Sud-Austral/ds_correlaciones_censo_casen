...
## Pregunta **P03C**: Material de construcción del piso
...
write_xlsx(union_final_urb, "P03C_urbano.xlsx")
```
...
saveRDS(tabla,"tablas_de_corr/C_P03C_URBANO.rds")
```
...
```{r}
#union_final_urb_corr  <- union_final_urb[,-c(1)]
write_xlsx(union_final_urb, "P03C_rural.xlsx")
```
...
```{r}
names(tabla)[1] <- "Correlación"
saveRDS(tabla,"tablas_de_corr/C_P03C_RURAL.rds")
```
