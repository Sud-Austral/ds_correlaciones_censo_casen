---
title: Expansión de la CASEN sobre el CENSO (Región 01) URBANO
author:
- name: VE-CC-AJ
...
abstract: |
  Expandiremos los ingresos promedios comunales obtenidos de la CASEN sobre la categoría de respuesta que más alto correlaciona con los ingresos expandidos (obtenidos de la multiplicación del ingreso promedio y los habitantes), ambos a nivel comunal.
...
```{r}
saveRDS(h_y_m_comuna_corr_01, "casen_censo_region_01.rds")
```
