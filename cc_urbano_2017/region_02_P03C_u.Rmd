...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.8581).
...
<br>
 ...
 $$ \hat Y = e^{15.57181 +0.8037187  \cdot ln{X}} $$ 
...
```{r}
saveRDS(h_y_m_comuna_corr, "P03C/region_02_P03C_u.rds")
```
