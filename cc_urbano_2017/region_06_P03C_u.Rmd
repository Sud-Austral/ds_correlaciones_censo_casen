...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.9851).
...
<br> 
 ...
 $$ \hat Y = e^{13.62965 +1.034797  \cdot ln{X}} $$ 
...
```{r}
saveRDS(h_y_m_comuna_corr, "P03C/region_06_P03C_u.rds")
```
