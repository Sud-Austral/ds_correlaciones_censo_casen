...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.937).
...
<br>  
 ...
 $$ \hat Y = e^{14.31647 +0.9570461  \cdot ln{X}} $$ 
...
```{r}
saveRDS(h_y_m_comuna_corr, "P03C/region_13_P03C_u.rds")
```
```{r}
