...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.9764).
...
<br>  
 ...
 $$ \hat Y = e^{13.79726 +0.9865098  \cdot ln{X}} $$ 
...
```{r}
saveRDS(h_y_m_comuna_corr, "P03C/region_09_P03C_u.rds")
```
