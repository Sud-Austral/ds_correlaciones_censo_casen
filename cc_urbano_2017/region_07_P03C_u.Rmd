...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.9839).
...
<br> 
 ...
 $$ \hat Y = e^{13.45262 +1.044784  \cdot ln{X}} $$ 
...
```{r}
saveRDS(h_y_m_comuna_corr, "P03C/region_07_P03C_u.rds")
```
