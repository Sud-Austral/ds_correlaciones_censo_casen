...
Es éste el modelo que nos entrega el mayor coeficiente de determinación de todos (0.9694).
...
<br> 
 ...
 $$ \hat Y = e^{13.63759 +1.023807  \cdot ln{X}} $$ 
...
```{r}
saveRDS(h_y_m_comuna_corr, "P03C/region_08_P03C_u.rds")
```
